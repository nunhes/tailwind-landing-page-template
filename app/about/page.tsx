      ...
      <div className="max-w-6xl px-4 mx-auto sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 mx-auto text-center md:pb-20">
            <h1 className="h1">We are UI/UX <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-400">designers</span><span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-pink-400">.</span></h1>
          </div>
              ...
              <div className="flex flex-wrap mb-3 -mx-3">
                <div className="w-full px-3">
                  <button className="relative flex items-center w-full px-0 text-white bg-gray-900 btn hover:bg-gray-800">
                    <svg className="w-4 h-4 mx-4 text-white opacity-75 fill-current shrink-0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
